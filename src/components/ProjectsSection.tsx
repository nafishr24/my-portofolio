...
const ProjectsSection = () => {
  ...
  return (
    <Animasi delay={200}>
      <section id="projects" className="py-20 bg-gray-50 backdrop-blur-sm scroll-mt-16">
                  ...
                  {filteredProjects.length > 1 && (
                    <div className="absolute inset-0 flex items-center justify-between p-4 z-10">
                      <Button
                        ...
                        variant="ghost"
                        size="icon"
                        className="h-10 w-10 rounded-full bg-black/30 hover:bg-black/50 backdrop-blur-sm text-white hover:scale-110 shadow-lg"
                      >
